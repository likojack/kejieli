export default class Constants {
  public static IAN_REID = { name: 'Ian Reid', link: 'https://cs.adelaide.edu.au/~ianr/' };
  ...
  public static JULIAN_STRAUB = { name: 'Julian Straub', link: 'http://people.csail.mit.edu/jstraub/' };
  public static STEVEN_LOVEGROVE = { name: 'Steven Lovegrove', link: 'https://scholar.google.com/citations?user=JVum8voAAAAJ&hl=en' };
  public static RICHARD_NEWCOMBE = { name: 'Richard Newcombe', link: 'https://scholar.google.co.uk/citations?user=MhowvPkAAAAJ&hl=en' };
